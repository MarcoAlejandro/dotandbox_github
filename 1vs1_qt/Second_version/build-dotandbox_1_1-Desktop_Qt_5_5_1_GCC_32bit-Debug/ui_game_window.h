...
public:
    ...
    void setupUi(QDialog *game_window)
    {
        ...
        bandera = new QLabel(game_window);
        bandera->setObjectName(QStringLiteral("bandera"));
        bandera->setGeometry(QRect(250, 300, 67, 17));
        layoutWidget->raise();
        layoutWidget->raise();
        layoutWidget->raise();
        g_map->raise();
    ...
    void retranslateUi(QDialog *game_window)
    {
        ...
        bandera->setText(QApplication::translate("game_window", "TextLabel", 0));
    } // retranslateUi
