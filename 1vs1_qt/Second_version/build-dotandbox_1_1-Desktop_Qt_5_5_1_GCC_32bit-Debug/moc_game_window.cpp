...
#include "../dotandbox_1_1/game_window.h"
...
QT_MOC_LITERAL(1, 12, 9), // "act_score"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9) // "show_turn"

    },
    "game_window\0act_score\0\0show_turn"
};
...
void game_window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->act_score((*reinterpret_cast< uint(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2]))); break;
        case 1: _t->show_turn((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject game_window::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_game_window.data,
      qt_meta_data_game_window,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *game_window::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_game_window.stringdata0))
        return static_cast<void*>(const_cast< game_window*>(this));
